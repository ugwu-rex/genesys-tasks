...
moodBox.style.width = "140px";
moodBox.style.height = "140px";
moodBox.style.backgroundColor = "purple";
moodBox.style.textAlign = "center";
moodBox.style.lineHeight = "140px";
moodBox.style.marginBottom = "10px";

growBtn.addEventListener("click", function () {
  moodBox.style.width = parseInt(moodBox.style.width) + 20 + "px";
  moodBox.style.height = parseInt(moodBox.style.height) + 20 + "px";
  moodBox.style.lineHeight = moodBox.style.height;
});

shrinkBtn.addEventListener("click", function () {
  let newWidth = Math.max(80, parseInt(moodBox.style.width) - 20);
  let newHeight = Math.max(60, parseInt(moodBox.style.height) - 20);
  moodBox.style.width = newWidth + "px";
  moodBox.style.height = newHeight + "px";
  moodBox.style.lineHeight = moodBox.style.height;
});
